...
interface BwaBweiModalProps {
    ...
    onWin: () => void;   // Called when user wins
}
...
const BwaBweiModal: React.FC<BwaBweiModalProps> = ({ isOpen, onClose, onReset, onWin }) => {
    ...
    return (
        <div className="fixed inset-0 z-[70]">
            ...
            <div className="absolute inset-0 overflow-y-auto flex items-center justify-center p-4">
                {/* Cinematic Container */}
                <div className="relative w-full max-w-4xl min-h-[600px] flex flex-col items-center justify-center p-8 md:p-12 text-center animate-in zoom-in-95 duration-700 my-auto">
                                ...
                                {outcomeType === 'win' && (
                                    <div className="flex flex-col items-center max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
                                        ...
                                        <div className="bg-gradient-to-br from-white/10 to-transparent border border-white/20 p-8 md:p-12 rounded-3xl mb-8 backdrop-blur-md shadow-[0_0_40px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                                            ...
                                            <p className="text-white/60 text-xs font-mono uppercase tracking-[0.2em] mt-6 mb-8">
                                                We are preparing that transformation now.
                                            </p>

                                            <div className="flex justify-center pb-4 pt-4 z-50 relative">
                                                <button
                                                    onClick={onClose}
                                                    className="px-12 py-5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl shadow-[0_0_30px_rgba(16,185,129,0.4)] font-mono text-sm uppercase tracking-widest transition-all hover:scale-105 border border-emerald-400/50"
                                                >
                                                    Back to Map
                                                </button>
                                            </div>
